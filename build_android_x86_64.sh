...
PREBUILT=$ANDROID_NDK/toolchains/x86_64-4.9/prebuilt/darwin-x86_64
...
--extra-cflags="-I../x264-android/android/x86_64/include" \
--extra-ldflags="-L../x264-android/android/x86_64/lib" "
