...
PREBUILT=$ANDROID_NDK/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64
...
--extra-cflags="-I../x264-android/android/arm/include" \
--extra-ldflags="-L../x264-android/android/arm/lib" "
