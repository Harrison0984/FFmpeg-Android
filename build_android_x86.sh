...
PREBUILT=$ANDROID_NDK/toolchains/x86-4.9/prebuilt/darwin-x86_64
PATH_X264=../x264
...
--extra-cflags="-I../x264-android/android/x86/include" \
--extra-ldflags="-L../x264-android/android/x86/lib""
